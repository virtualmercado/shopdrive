...
const StorePromotionsContent = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // Fetch all products with promotional prices
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                {products.length} {products.length === 1 ? "produto" : "produtos"} com desconto
              </p>
            </div>
          </div>
        </div>
