        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center shadow-lg rounded-lg p-8">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-justify">
              ...
              {/* Social Media Icons - 4 per row on mobile/tablet */}
              <div className="grid grid-cols-4 md:grid-cols-8 gap-6 justify-items-center">
                <Instagram className="h-10 w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" />
                <Facebook className="h-10 w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" />
                <Youtube className="h-10 w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" />
