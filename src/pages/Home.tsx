        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              {/* Social Media Icons - 4 per row on mobile/tablet, 2 rows of 4 on tablet */}
              <div className="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-8 gap-6 justify-items-center">
                <Instagram className="h-10 w-10 md:h-8 md:w-8 lg:h-10 lg:w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" />
                <Facebook className="h-10 w-10 md:h-8 md:w-8 lg:h-10 lg:w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" />
                <Youtube className="h-10 w-10 md:h-8 md:w-8 lg:h-10 lg:w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" />
                <svg className="h-10 w-10 md:h-8 md:w-8 lg:h-10 lg:w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                </svg>
                <Linkedin className="h-10 w-10 md:h-8 md:w-8 lg:h-10 lg:w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" />
                <svg className="h-10 w-10 md:h-8 md:w-8 lg:h-10 lg:w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" viewBox="0 0 24 24" fill="currentColor">
                ...
                <Twitter className="h-10 w-10 md:h-8 md:w-8 lg:h-10 lg:w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" />
                <svg className="h-10 w-10 md:h-8 md:w-8 lg:h-10 lg:w-10 text-primary transition-all duration-300 hover:scale-125 hover:opacity-70 cursor-pointer" viewBox="0 0 24 24" fill="currentColor">
