...
import { Menu, X, Instagram, Facebook, Youtube, TrendingUp, Linkedin, Twitter, MessageCircle } from "lucide-react";
          ...
          {isMobileMenuOpen && (
            <nav className="md:hidden mt-4 pb-4 border-t pt-4">
              <div className="flex flex-col gap-3">
                <a href="/#beneficios" onClick={() => handleNavClick('beneficios')} className="text-base font-bold text-foreground hover:text-primary transition-colors cursor-pointer py-2">{headerContent.menuBenefits}</a>
                <a href="/#planos" onClick={() => handleNavClick('planos')} className="text-base font-bold text-foreground hover:text-primary transition-colors cursor-pointer py-2">{headerContent.menuPlans}</a>
                <a href="/#como-funciona" onClick={() => handleNavClick('como-funciona')} className="text-base font-bold text-foreground hover:text-primary transition-colors cursor-pointer py-2">{headerContent.menuHowItWorks}</a>
              </div>
            </nav>
          )}
        </div>
