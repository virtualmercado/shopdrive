...
import logoShopDriveAsset from "@/assets/logo-shopdrive-oficial.png.asset.json";
      ...
      <Card className="w-full max-w-md p-8">
        <div className="text-center mb-8">
          <Link to="/" className="flex justify-center mb-6">
            <img src={logoShopDriveAsset.url} alt="ShopDrive - Sua loja no digital" className="h-auto w-auto max-w-[220px] sm:max-w-[260px] max-h-16 object-contain" />
          </Link>
