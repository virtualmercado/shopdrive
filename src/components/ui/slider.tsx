...
>(({ className, merchantStyled = false, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    className={cn(
      ...
      merchantStyled && "merchant-slider",
      className
    )}
    data-merchant-styled={merchantStyled ? "slider" : undefined}
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-secondary">
      <SliderPrimitive.Range 
        className={cn(
          "absolute h-full",
          merchantStyled ? "bg-[var(--merchant-primary)]" : "bg-primary"
        )} 
      />
    ...
    <SliderPrimitive.Thumb 
      className={cn(
        ...
        merchantStyled ? "border-[var(--merchant-primary)]" : "border-primary"
      )} 
    />
  </SliderPrimitive.Root>
));
